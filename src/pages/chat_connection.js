...
// ChatConnection.prototype.talk = function(message) {
...
//     connected: function() {
//       console.log('connected to RoomChannel. Sender: ' + scope.senderId + ', Receiver: ' + scope.receiverId);
//     },
//     disconnected: function() {},
//     received: function(data) {
